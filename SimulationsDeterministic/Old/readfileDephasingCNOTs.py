...
fig.suptitle('Fidelity Scaling -  Dephasing Noise + Noisy CNOTs')
...
PLOT_GUIDES = [(T1[-1],T2[0],CNOT_ERROR[0]),(T1[-1],T2[0],CNOT_ERROR[1]),(T1[-1],T2[0],CNOT_ERROR[2]),(T1[-1],T2[0],CNOT_ERROR[3]),(T1[-1],T2[0],CNOT_ERROR[4])]
...
ax1.set_title('Fidelity Scaling -  Dephasing Noise: T2 = 10^7')
ax1.set_xscale('log')
#plt.yscale('log')
...
ax2.set_title('Fidelity Scaling -  Dephasing Noise: T2 = 10^8')
ax2.set_xscale('log')
#plt.yscale('log')
