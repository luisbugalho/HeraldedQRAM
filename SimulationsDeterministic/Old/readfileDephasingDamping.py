...
fig.suptitle('Fidelity Scaling -  Dephasing + Damping Noise')
...
PLOT_GUIDES = [(T1[0],T2[0],CNOT_ERROR[-1]),(T1[1],T2[0],CNOT_ERROR[-1]),(T1[2],T2[0],CNOT_ERROR[-1])]
...
for i in range(0,len(data_tree)):
	print(data_tree[i])
	ax1.errorbar(data_points,data_tree[i],data_tree_std[i],label='Binary Tree Fidelity - T1 = ' + str("{:.0e}".format(T1[i])))
...
PLOT_GUIDES = [(T1[0],T2[1],CNOT_ERROR[-1]),(T1[1],T2[1],CNOT_ERROR[-1]),(T1[2],T2[1],CNOT_ERROR[-1])]
...
for i in range(0,len(data_tree)):
	print(data_tree[i])
	ax2.errorbar(data_points,data_tree[i],data_tree_std[i],label='Binary Tree Fidelity - T1 = ' + str("{:.0e}".format(T1[i])))
